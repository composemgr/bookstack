...
Platform for organizing and storing documentation and wiki content
...
- **bookstack**: bookstack/bookstack:latest
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/bookstack/main/docker-compose.yaml" -o compose.yml
```
